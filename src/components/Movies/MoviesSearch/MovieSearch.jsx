...
import { Input, Button, Form, List, ListItem, MovieTitle, StyledLink, ImageStyled} from "./MovieSearch.styled";
...
function MovieSearch() {
    ...
    const handleSubmit = (e) => {
        ...
        const nextParams = e.target.elements.query.value !== "" ? { search: e.target.elements.query.value } : {};
