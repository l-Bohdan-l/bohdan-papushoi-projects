...
import { Button, MovieDetailsWrapper, MovieImage, MovieTitle, GenresStyled, AdditionalInfoList, AdditionalInfoItem } from "./MovieDetails.styled";
...
const MovieDetails = () => {
    ...
    return (
        <section>
            <Transition in={status === Status.RESOLVED && movie} timeout={transitionDuration}>
                {state => (
                    <div style={{
            ...
            {status === Status.RESOLVED && movie && (         
                <>
                    <MovieDetailsWrapper>               
                    <MovieImage src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt={movie.original_title} />                
                    <div>
                    ...
                    <AdditionalInfoList>
                        <AdditionalInfoItem>
                            <Link to='cast' preventScrollReset={true}>Cast</Link>
                        </AdditionalInfoItem>
                        <AdditionalInfoItem>
                            <Link to='reviews' preventScrollReset={true}>Reviews</Link>
                        </AdditionalInfoItem>
                    </AdditionalInfoList>
                </>           
            )}
