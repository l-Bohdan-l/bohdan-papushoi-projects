    ...
    return (
        <Formik initialValues={initialValues}     
            ...
            <RegistrationForm autoComplete="off">
                <Field name="name" type="text" as={TextField} label="name" variant="standard" />
                <Field name="email" type="email" as={TextField} label="email" variant="standard" />
                <Field name="password" type="password" as={TextField} label="password" variant="standard" />
